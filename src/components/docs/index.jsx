...
export function Docs() {
  return (
    <div className="max-w-full py-8  text-neutral-800 dark:text-neutral-200 ">
      <h2 className="mb-10 text-3xl font-medium">Documentation</h2>

      <section className="selection:bg-yellow-400 selection:text-neutral-700 dark:bg-neutral-800  mb-16 bg-white px-3 py-8 md:px-8">
        <h2 className="  text-neutral-800 dark:text-neutral-200 mb-3 text-2xl font-medium">File Structure</h2>
        <div className="pl-2  text-neutral-800 dark:text-neutral-200">
      ...
      <section className="px-3 py-8 md:px-8">
        <h2 className="text-neutral-800 dark:text-neutral-200 text-2xl font-medium">File Structure explained</h2>

        <div className="mb-8 mt-4">
          <div className="flex">
            <FolderIcon /> <strong className="text-neutral-800 dark:text-neutral-200  px-1">sidebar</strong>
          </div>
          ...
          <div className="mt-6 flex flex-wrap pl-6 md:flex-nowrap">
            <FolderIcon /> <span className="px-2 font-medium">data.tsx</span> :
            <p className="pl-1">
          ...
          <div className="mt-6 flex flex-wrap pl-6 md:flex-nowrap">
            <FolderIcon /> <span className="px-2 font-medium">Sidebar.tsx</span> :
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <FolderIcon /> <span className="px-1 font-medium">Layout.tsx :</span>{" "}
            contains the
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <FolderIcon /> <span className="px-1 font-medium">Overlay.tsx :</span>{" "}
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <FolderIcon /> <span className="px-1 font-medium">Provider.tsx :</span>{" "}
        ...
        <div>
          <div className="mt-8 flex flex-wrap md:flex-nowrap">
            <FolderIcon /> <span className="px-1 font-medium">TopBar.tsx :</span>
